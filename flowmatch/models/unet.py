# implementation from: https://github.com/openai/guided-diffusion/blob/main/guided_diffusion
# modified to include bidirectional conditioning
...
class UNetModel(nn.Module):
    ...
    def forward(self, x, timesteps, y=None, bidir_cond=None):
        ...
        :param bidir_cond: an [N] Tensor of bidirectional conditioning, if applicable.
