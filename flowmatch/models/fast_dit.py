...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        num_classes=1000,
        #learn_sigma=True, # Modified: we dont learn sigma as we do flow matching
        bidirectional=False, # Modified: support bidirectional conditioning
        grad_checkpointing=False, # Modified: support optional gradient checkpointing instead of always using it
    ):
        super().__init__()
    ...
    def forward(self, x, t, y, bidir_cond=None):
        ...
        y: (N,) tensor of class labels or other conditioning information (e.g. CrossFlow indicator function to enable classifier-free guidance)
